...
use Lynda\MagazineBundle\Entity\Job;
use Lynda\MagazineBundle\Form\JobType;
...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LyndaMagazineBundle:Job')->findAll();
     ...
     * @Method("POST")
     * @Template("LyndaMagazineBundle:Job:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $entity = new Job();
        $entity->setPosition("WebDesigner");
        ...
        if ($form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $category = new \Lynda\MagazineBundle\Entity\Category();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LyndaMagazineBundle:Job')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LyndaMagazineBundle:Job:edit.html.twig")
     */
